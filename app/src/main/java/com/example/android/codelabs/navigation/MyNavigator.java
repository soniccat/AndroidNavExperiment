...
public class MyNavigator extends Navigator<MyNavigator.Destination> {
    private static final String TAG = "MyFragmentNavigator";
    private static final String KEY_BACK_STACK_IDS = "androidx-nav-myfragment:navigator:backStackIds";
    ...
    public MyNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                             int containerId) {
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(MyNavigator.class));
        }
